...
public class roomSpawn : MonoBehaviour
{
    ...
    {       //spawning and translating the left door GameObject leftDoor = Instantiate(pfDoor);  leftDoor.transform.position = new Vector3(-75, 2, 0);  leftDoor.transform.localScale = new Vector3(10, 10, 20);   //spawning and translating the right door  GameObject rightDoor = Instantiate(pfDoor);  rightDoor.transform.position = new Vector3(75, 2, 0);  rightDoor.transform.localScale = new Vector3(10, 10, 20);  //spawning and translating the top door  GameObject topDoor = Instantiate(pfDoor);  topDoor.transform.position = new Vector3(0, 2, 75);  topDoor.transform.localScale = new Vector3(20, 10, 10);  topDoor.transform.Rotate(180, 0, 0);  //spawning and translating the bottom door  GameObject bottomDoor = Instantiate(pfDoor);  bottomDoor.transform.position = new Vector3(0, 2, -75);  bottomDoor.transform.localScale = new Vector3(20, 10, 10);  bottomDoor.transform.Rotate(180, 0, 0);
        return;
    }
