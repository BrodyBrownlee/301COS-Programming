...
public class roomSpawn : MonoBehaviour
{
    ...
    public void wallSpawn()
    {
        ...
        if (roomArray[Player_Movement.playerScript.playerY + 1, Player_Movement.playerScript.playerY] == 0 )
        {
            rightWallSpawn();
        }
        if (roomArray[Player_Movement.playerScript.playerY, Player_Movement.playerScript.playerY - 1] == 0)
        {
            topWallSpawn();
        }
        if (roomArray[Player_Movement.playerScript.playerY, Player_Movement.playerScript.playerY + 1] == 0)
