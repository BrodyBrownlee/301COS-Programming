...
public class roomSpawn : MonoBehaviour
{
    ...
    void Start()
    {
        public int maxY = roomArray.GetLength(0) - 1;
        public int maxX = roomArray.GetLength(1) - 1;
    ...
    {
        if (roomArray[Player_Movement.playerScript.playerY, Player_Movement.playerScript.playerX - 1] == 0 || Player_Movement.playerScript.playerX == 0)
        {
            leftWallSpawn();
        }
        if (roomArray[Player_Movement.playerScript.playerY, Player_Movement.playerScript.playerX + 1] == 0 || Player_Movement.playerScript.playerX == maxX)
        {
            rightWallSpawn();
        }
        if (roomArray[Player_Movement.playerScript.playerY - 1, Player_Movement.playerScript.playerX] == 0 || Player_Movement.playerScript.playerY-- == 0)
        {
            topWallSpawn();
        }
        if (roomArray[Player_Movement.playerScript.playerY + 1, Player_Movement.playerScript.playerX] == 0 || Player_Movement.playerScript.playerY-- == maxY)
        {
            bottomWallSpawn();
        }
    }
