...
public class roomSpawn : MonoBehaviour
{
    ...
    public void wallSpawn()
    {
        ...
        if (roomArray[Player_Movement.playerScript.playerY + 1, Player_Movement.playerScript.playerX] == 0 || roomArray[Player_Movement.playerScript.playerY + 1, Player_Movement.playerScript.playerX] == -1)
        {
            bottomWallSpawn();
        }
    }
