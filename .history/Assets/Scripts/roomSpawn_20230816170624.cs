...
public class roomSpawn : MonoBehaviour
{
    ...
    {
        if (roomArray[Player_Movement.playerScript.playerX - 1, Player_Movement.playerScript.playerY] == 0)
        {
            leftWallSpawn();
        }
        if (roomArray[Player_Movement.playerScript.playerX + 1, Player_Movement.playerScript.playerY] == 0 )
        ...
        if (roomArray[Player_Movement.playerScript.playerX, Player_Movement.playerScript.playerY - 1] == 0)
        {
            topWallSpawn();
        }
        if (roomArray[Player_Movement.playerScript.playerX, Player_Movement.playerScript.playerY + 1] == 0 || roomArray[Player_Movement.playerScript.playerX, Player_Movement.playerScript. == null)
        {
            bottomWallSpawn();
        }
    }
