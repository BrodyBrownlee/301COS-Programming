...
public class roomSpawn : MonoBehaviour
{
    ...
    {
        if ( || Player_Movement.playerScript.playerX == 0 roomArray[Player_Movement.playerScript.playerY, Player_Movement.playerScript.playerX - 1] == 0)
        {
            leftWallSpawn();
        }
        if (Player_Movement.playerScript.playerX == 3 || roomArray[Player_Movement.playerScript.playerY, Player_Movement.playerScript.playerX + 1] == 0 )
        {
            rightWallSpawn();
        }
        if ( Player_Movement.playerScript.playerY-- == 0 || roomArray[Player_Movement.playerScript.playerY - 1, Player_Movement.playerScript.playerX] == 0 )
        {
            topWallSpawn();
        }
        if (Player_Movement.playerScript.playerY-- == 5|| roomArray[Player_Movement.playerScript.playerY + 1, Player_Movement.playerScript.playerX] == 0 )
        {
            bottomWallSpawn();
        }
    }
